  ...
  return (
    <div className="bg-background min-h-screen py-20">
      <div className="container mx-auto px-6 max-w-4xl">
        <h1 className="text-4xl font-bold text-foreground mb-8 border-b pb-4">Términos y Condiciones</h1>
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">3. Uso del Bot de WhatsApp</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">4. Pagos e Inscripciones</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">5. Propiedad Intelectual</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">6. Limitación de Responsabilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">7. Contacto</h2>
            <p>
