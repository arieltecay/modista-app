...
export const TestimonialsSection: React.FC = React.memo(() => {
    ...
    return (
        <section className="bg-card py-16 sm:py-24 overflow-hidden border-t border-border min-h-[400px]">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-sm font-bold text-indigo-600 uppercase tracking-[0.2em] mb-3">
                        Testimonios
                    </h2>
                    <p className="text-3xl font-bold text-foreground sm:text-4xl tracking-tight">
                ...
                <div className="relative mt-10">
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-card to-transparent z-10"></div>
                            <div className="absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-card to-transparent z-10"></div>
