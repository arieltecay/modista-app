  ...
  return (
    <div className="fixed inset-0 !z-[9999] overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div
          className="fixed inset-0 !bg-black/60 !opacity-100 transition-opacity"
          aria-hidden="true"
          onClick={onClose}
        ></div>
        ...
        <div className="inline-block align-bottom !bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border-2 border-indigo-100">
